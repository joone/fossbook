...
describe("Multilingual site build", () => {
  ...
  it("generates separate static output for each configured language", () => {
    ...
    assert.match(englishPost, /href="https:\/\/example\.com\/posts\/translated\/"[^>]*>English<\/a>/);
    assert.match(englishPost, /href="https:\/\/example\.com\/ko\/posts\/translated\/"[^>]*>한국어<\/a>/);
    ...
    assert.match(koreanPost, /href="https:\/\/example\.com\/posts\/translated\/"[^>]*>English<\/a>/);
    assert.match(koreanPost, /href="https:\/\/example\.com\/ko\/posts\/translated\/"[^>]*>한국어<\/a>/);
