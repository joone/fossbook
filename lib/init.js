...
function initProject(options = {}) {
  ...
  // transcriptLabel, copyLinkLabel, linkCopiedLabel, copyLinkErrorLabel,
  // shareBlockLabel, shareCommentLabel, shareCommentPlaceholder,
  // shareOnXLabel, shareOnFacebookLabel, shareOnInstagramLabel,
  // instagramShareCopiedLabel, and instagramShareCopyErrorLabel.
